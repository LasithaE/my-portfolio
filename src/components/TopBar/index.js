  ...
  return (
    ...
    <div className="flex items-center justify-between h-16 w-full px-6 md:mt-5">
      ...
      <div className="hidden md:flex justify-center items-center gap-6 flex-grow mt-4">
        <button className="mx-2 cursor-pointer" onClick={() => setClicked("Home")}>
          <Link href="/">
            <WavyUnderline text={"Home"} hovered={null} clicked={clicked} />
          </Link>
        </button>
        <Star size={14} weight={"fill"} />
        <button className="mx-2 cursor-pointer" onClick={() => setClicked("Work")}>
          <Link href="/work">
            <WavyUnderline text={"Work"} hovered={null} clicked={clicked} />
          </Link>
        </button>
        <Star size={14} weight={"fill"} />
        <button className="mx-2 cursor-pointer" onClick={() => setClicked("About")}>
          <Link href="/about">
      ...
      <button className="px-4 py-2 text-white bg-gray-800 border border-gray-800 rounded-lg shadow-md transition shadow-2xl 
      ...
      <div className="absolute top-0 left-0 w-full h-screen bg-black/50 flex flex-col items-center justify-center z-50">
        <div className="bg-white p-8 rounded-lg shadow-lg w-[80%] max-w-[400px] flex flex-col items-center">
          ...
          <nav className="flex flex-col gap-6 text-xl mt-6">
            <button className="cursor-pointer" onClick={() => { setClicked("Home"); setMenuOpen(false); }}>
              <Link href="/">
                <WavyUnderline text={"Home"} hovered={null} clicked={clicked} />
              </Link>
            </button>
            <button className="cursor-pointer" onClick={() => { setClicked("Work"); setMenuOpen(false); }}>
              <Link href="/work">
                <WavyUnderline text={"Work"} hovered={null} clicked={clicked} />
              </Link>
            </button>
            <button className="cursor-pointer" onClick={() => { setClicked("About"); setMenuOpen(false); }}>
              <Link href="/about">
                <WavyUnderline text={"About"} hovered={null} clicked={clicked} />
              </Link>
            </button>
            <button className="px-4 py-2 mt-4 text-white bg-gray-800 border border-gray-800 rounded-lg shadow-md 
            hover:bg-white hover:text-gray-800 hover:scale-105 transition"
